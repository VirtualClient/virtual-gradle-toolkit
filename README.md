...
## gg.virtualclient.multi-version
...
plugins {
    ...
    // Any project using `gg.virtualclient.multi-version` must have a parent with this root plugin applied.
...
plugins {
    ...
    // You can also overwrite some of these if need be. See the `gg.virtualclient.defaults.loom` README section.
...
### gg.virtualclient.multi-version.root
See the comments in the `root.gradle.kts` file above.

### gg.virtualclient.multi-version.api-validation
...
- [loom](#ggessentialdefaultsloom) (if the `gg.virtualclient.loom` plugin is applied)

Does not apply:
- [maven-publish](#ggessentialdefaultsmaven-publish)

### gg.virtualclient.defaults.java

Sets defaults related to the `java` Gradle plugin:
- encoding to UTF-8

### gg.virtualclient.defaults.loom

Sets defaults related to the `gg.virtualclient.loom` ([architectury-loom]) Gradle plugin.
...
### gg.virtualclient.defaults.mixin-extras
...
### gg.virtualclient.defaults.repo

Adds Essential and MavenCentral repos to the project.

### gg.virtualclient.defaults.maven-publish
...
Various utility functions are provided in the `gg.virtualclient.gradle.util` package.
...
See [the method docs](src/main/kotlin/gg/virtualclient/gradle/util/prebundle.kt) for more details.

```kotlin
import gg.virtualclient.gradle.util.prebundle
...
See [the docs on the class](src/main/kotlin/gg/virtualclient/gradle/util/RelocationTransform.kt) for more details.
...
The [`makeConfigurationForInternalDependencies` method](src/main/kotlin/gg/virtualclient/gradle/util/internalConfiguration.kt) creates a new configuration (by default named `internal`) which can be used to declare dependencies which are completely internal to the project.
...
#### [StripReferencesTransform](src/main/kotlin/gg/virtualclient/gradle/multiversion/StripReferencesTransform.kt)
...
dependencies {
    ...
    compileOnly("gg.virtualclient:universalcraft-1.8.9-forge:master-SNAPSHOT") {
...
#### [mergePlatformSpecifics](src/main/kotlin/gg/virtualclient/gradle/multiversion/mergePlatformSpecifics.kt)
...
#### [excludeKotlinDefaultImpls](src/main/kotlin/gg/virtualclient/gradle/multiversion/excludeKotlinDefaultImpls.kt)
...
See [the file](src/main/kotlin/gg/virtualclient/gradle/util/extensions.kt) for details.
